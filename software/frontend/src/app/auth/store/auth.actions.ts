...
export const loginUserGetTokensSuccess = createAction(
  '[Auth] Login User Get Tokens Success', props<{ username: string, token: string, refreshToken: string }>()
);

export const loginUserGetUserSuccess = createAction(
  '[Auth] Login User Get User Success', props<{ user: User }>()
);
...
export const loadUserFromLocalStorageSuccess = createAction(
  '[Auth] Load User From Local Storage Success', props<{ user: User, token: string, refreshToken: string }>()
);
...
export const refreshUserTokenSuccess = createAction(
  '[Auth] Refresh User Token Success', props<{ token: string, refreshToken: string }>()
);

export const refreshUserTokenFailure = createAction(
  '[Auth] Refresh User Token Failure', props<{ error: HttpErrorResponse | null }>()
);
